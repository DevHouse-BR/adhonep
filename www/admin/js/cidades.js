...
function populateResponsaveis(){
	ArrayResponsaveis = [];
	for (i=0; i<DevHouseDesktop.Stores.storeAtributosPessoais.data.length;i++){
		if ((DevHouseDesktop.Stores.storeAtributosPessoais.data.items[i].data.aplicacao == 2) || (DevHouseDesktop.Stores.storeAtributosPessoais.data.items[i].data.aplicacao == 3)) {
			ArrayResponsaveis.push({
				id: 'responsaveis-' + DevHouseDesktop.Stores.storeAtributosPessoais.data.items[i].data.idatributospessoais + '-Field',
				hiddenName: 'responsaveis[' + DevHouseDesktop.Stores.storeAtributosPessoais.data.items[i].data.idatributospessoais + ']',
				name: 'pessoas',
				fieldLabel: DevHouseDesktop.Stores.storeAtributosPessoais.data.items[i].data.atributo,
				xtype: 'comboPessoas',
				allowBlank: true,
				width : 200				
			});
