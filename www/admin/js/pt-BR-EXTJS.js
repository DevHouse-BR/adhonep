/*
 * Portuguese/Brazil Translation by Leonardo
 */
...
if(Ext.form.Action){
    Ext.form.Action.prototype.waitMsg = 'Gravando Dados Aguarde...';
	Ext.form.Action.prototype.waitTitle = 'Aguarde';
}
...
if(Ext.form.TextField){
   Ext.apply(Ext.form.TextField.prototype, {
      minLengthText : "Mínimo de {0} caracteres",
...
if(Ext.form.CheckboxGroup){
   Ext.apply(Ext.form.CheckboxGroup.prototype, {
      emptyText     : "Você precisa selecionar ao menos um item deste grupo"
   });
}
...
if(Ext.form.DateField){
   Ext.apply(Ext.form.DateField.prototype, {
	  ...
	  invalidText       : "{0} não é uma data válida - deve ser informado no formato dd/mm/aaaa",
      format            : "d/m/Y"
   });
}
