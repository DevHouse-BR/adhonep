...
<form action="index.php" method="post" name="login" class="form-login">
  ...
  <?php endif; ?>
  <div class="login-links"><div class="logged-in">
    ...
    <p><a href="<?php echo PHP_YOUR_ACTIVITY; ?>"><?php echo JText::_('YOUR_LAST_VISIT'); ?>: <span class="login-bold"><?php echo $lastvisit; ?> </span></a></p>
    <?php endif; ?>
  ...
  <div class="readon-wrap1"><div class="readon1-l"></div><a class="readon-main"><span class="readon1-m"><span class="readon1-r"><input type="submit" name="Submit" class="button" value="<?php echo JText::_('BUTTON_LOGOUT'); ?>" title="<?php echo JText::_('BUTTON_LOGOUT'); ?>" /></span></span></a></div><div class="clr"></div>
...
<div class="main-login-form">
  <form action="<?php echo JRoute::_( 'index.php', true, $params->get('usesecure')); ?>" method="post" name="login" class="form-login" >
    ...
    <div class="login-username">
      ...
      <br />
      <div class="input-field-l"><input name="username" id="mod_login_username" type="text" class="inputbox png" value="<?php echo JText::_('USERNAME'); ?>" alt="<?php echo JText::_('USERNAME'); ?>" onblur="if(this.value=='') this.value='<?php echo JText::_('USERNAME'); ?>';" onfocus="if(this.value=='<?php echo JText::_('USERNAME'); ?>') this.value='';" size="26" /></div>
    </div>
    <div class="login-password">
      <label for="mod_login_password"><?php echo JText::_('PASSWORD') ?></label>
      <br />
      <div class="input-field-l"><input name="passwd" id="mod_login_password" type="password" class="inputbox png" value="<?php echo JText::_('PASSWORD'); ?>" alt="<?php echo JText::_('PASSWORD'); ?>" onblur="if(this.value=='') this.value='<?php echo JText::_('PASSWORD'); ?>';" onfocus="if(this.value=='<?php echo JText::_('PASSWORD'); ?>') this.value='';" size="26" /></div>
    </div>
    ...
    <div class="remember-me">
      ...
      <label for="mod_login_remember" class="remember"><?php echo JText::_('REMEMBER_ME') ?></label>
    </div>
    <?php endif; ?>
	<div class="readon-surround">
    ...
    <p> <?php echo JText::_('NO_ACCOUNT'); ?> <a href="<?php echo JRoute::_('index.php?option=com_user&task=register#content'); ?>"> <?php echo JText::_('REGISTER'); ?></a> </p>
    <?php endif;
