...
<div>
	...
	?>
		<!-- File Upload Form -->
		<div class="form-surround"><form action="<?php echo JURI::base();?>index.php?option=com_community&amp;view=photos&amp;task=upload&amp;albumid=<?php echo $albumid;?>&amp;tmpl=component&amp;<?php echo $session->getName().'='.$session->getId(); ?>" id="uploadForm" method="post" enctype="multipart/form-data">
			<input type="file" id="image-upload" class="button" name="Filedata" />
			<div class="readon-wrap1"><div class="readon1-l"></div><a class="readon-main"><span class="readon1-m"><span class="readon1-r"><input type="submit" class="button" id="file-upload-submit" value="<?php echo JText::_('CC BUTTON START UPLOAD'); ?>"/></span></span></a></div><div class="clr"></div>
