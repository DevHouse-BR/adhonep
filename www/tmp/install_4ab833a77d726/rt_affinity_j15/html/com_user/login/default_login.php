...
<form action="<?php echo JRoute::_( 'index.php', true, $this->params->get('usesecure')); ?>" method="post" name="login" id="login" class="form-login<?php echo $this->params->get( 'pageclass_sfx' ); ?>">
	...
	<fieldset>
		<div class="name">
			...
			<div class="input-field-l"><input type="text" onfocus="if(this.value=='Username') this.value='';" onblur="if(this.value=='') this.value='Username';" alt="Username" value="Username" class="inputbox" name="username" id="user" size="20"/></div>
		</div>
		<div class="pass">
			<label for="pass" ><?php echo JText::_( 'Password' ); ?></label>
			<div class="input-field-l"><input name="passwd" type="password" class="inputbox" size="20" id="pass" /></div>
		</div>
