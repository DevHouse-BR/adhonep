				...
				addCriteria: function ( ) {
					...
					criteria +='<div id="criteria'+keynum+'" style="margin: 0 0 10px 0;">';
						...
						criteria +='<div id="selectcondition'+keynum+'" style="float:left; margin-right:10px;">';
							...
							criteria +='</select>';
						criteria +='</div>';
						criteria +='<div id="valueinput'+keynum+'" style="float:left; margin-right:10px;">';
...
<form action="" method="GET">
	...
	<div id="optionContainer">
		<div>
			<a class="add" style="padding: 0pt 0pt 0pt 20px; display: inline; text-indent: 0px;" href="javascript:void(0);" onclick="jsAdvanceSearch.action.addCriteria();"><?php echo JText::_("Add Criteria"); ?></a>
		</div>
		<div class="news-separator"></div>
		<div style="margin-left: -3px;">
			<input type="radio" name="operator" id="operator_all" value="and"> <?php echo JText::_("CC MATCH ALL CRITERIA"); ?>
			<input type="radio" name="operator" id="operator_any" value="or"> <?php echo JText::_("CC MATCH ANY CRITERIA"); ?>
			<div class="clr"></div>
			<div class="readon-wrap1"><div class="readon1-l"></div><a class="readon-main"><span class="readon1-m"><span class="readon1-r"><input type="submit" class="button" value="<?php echo JText::_("CC BUTTON SEARCH");?>" style="margin-left:5px;"></span></span></a></div><div class="clr"></div>
