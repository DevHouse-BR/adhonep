...
?>
		...
		?>
					<li class="mini-thumbs">
						<a href="<?php echo CRoute::_('index.php?option=com_community&view=groups&task=viewgroup&groupid='.$group->id); ?>">
							<img src="<?php echo JURI::root() . '/' . $group->thumb; ?>" alt="<?php echo $group->name; ?>" class="avatar hasTip" width="45" title="<?php echo htmlspecialchars( JText::_( $group->name )); ?>::<?php echo JText::_( $group->description ); ?>" />
						</a>
					</li>
		<?php
		}
