...
<div id="community-groups-wrap">
	...
	<div class="submit">
		<div class="readon-wrap1"><div class="readon1-l"></div><a class="readon-main"><span class="readon1-m"><span class="readon1-r"><input type="submit" value="<?php echo JText::_('CC BUTTON CREATE GROUP');?>" class="button validateSubmit" /></span></span></a></div>
		
		<div style="width: 25px; float: left; display: block; position: relative;">&nbsp;</div>
		
		<div class="readon-wrap1"><div class="readon1-l"></div><a class="readon-main"><span class="readon1-m"><span class="readon1-r"><button class="button" onclick="history.go(-1);return false;"><?php echo JText::_('CC BUTTON CANCEL');?></button></span></span></a></div><div class="clr"></div>
	</div>
</div>
