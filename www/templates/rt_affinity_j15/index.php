...
<html>
	...
	<body id="ff-<?php echo $fontfamily; ?>" class="<?php echo $fontstyle; ?> <?php echo $tstyle; ?> iehandle">
		...
		<!--<div id="top-bar" style="border: solid 1px red;">
			<div class="wrapper">
		...
		<div id="page-bg"><div id="page-bg2">
			<div class="wrapper">
				<!--Begin Horizontal Menu--><br />
                <table width="955" border="0" cellspacing="0" cellpadding="0" style="margin-left:11px;">
                	<tr>
                    	<td width="31" valign="top"><img src="<?php echo $this->baseurl ?>/templates/rt_affinity_j15/images/style2/horizmenu-tl.png" /></td>
                        <td valign="bottom" align="center" background="<?php echo $this->baseurl ?>/templates/rt_affinity_j15/images/style2/horizmenu-top.png">
                        </td>
                        <td width="31" valign="top"><img src="<?php echo $this->baseurl ?>/templates/rt_affinity_j15/images/style2/horizmenu-tr.png" /></td>
                    </tr>
                    <tr>
                    	<td background="<?php echo $this->baseurl ?>/templates/rt_affinity_j15/images/style2/l-esq.png" />&nbsp;</td>
                        <td valign="bottom" align="center" bgcolor="#FFFFFF">
                        	<img src="<?php echo $this->baseurl ?>/images/logo.jpg" /><br /><br />
                        </td>
                        <td background="<?php echo $this->baseurl ?>/templates/rt_affinity_j15/images/style2/l-dir.png" />&nbsp;</td>
                    </tr>
                </table>
				<?php if($mtype != "none") : ?>
				<div id="horiz-menu2"><div id="horiz-menu" class="<?php echo $mtype; ?>"><div id="horiz-menu3">
				<?php if($mtype != "module") : ?>
					<?php echo $topnav; ?>
				<?php else: ?>
			...
			<div id="bottom" style="background-color:#333;color:#FFF;">
				<div class="wrapper">
					...
					<div class="copyright-block">
                    	<img src="<?php echo $this->baseurl ?>/templates/rt_affinity_j15/images/style2/fundo-rodape2.png" style="position:absolute; margin-left:-230px; margin-top:-10px;"/>
						<div id="copyright">
							&copy; Copyright 2009, Todos os Direitos Reservados - Desenvolvido por <a target="_blank" style="font-weight:bold;" href="http://www.devhouse.com.br">Devhouse</a>
						</div>
						<img src="<?php echo $this->baseurl ?>/templates/rt_affinity_j15/images/style2/fundo-rodape.png" style="position:absolute; margin-left:530px; margin-top:-50px;"/>
                    </div>
					<?php else: ?>
